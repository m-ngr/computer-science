...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname parameterization-my-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;;NAME: Mahmoud Elnagar
;;DATE: 14/12/2021
;; parameterization-my-solution.rkt
...
(check-expect (contains? "Tokyo" (cons "UBC" (cons "McGill" empty))) false)
...
;; apply fn to all numbers of lon, and produce a list of the result

(check-expect (map2 sqr empty) empty)
(check-expect (map2 sqr (list 3 4)) (list 9 16))
(check-expect (map2 sqrt (list 9 16)) (list 3 4))
(check-expect (map2 string-length (list "9" "16")) (list 1 2))
...
;; filter the given list to contain only elements for which fn? produces true
